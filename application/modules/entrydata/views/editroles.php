		...
		<div class="row">
			<div class="col-12  align-self-center">
				<div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
					<div class="w-sm-100 mr-auto"><h4 class="mb-0"><?php echo $menuname;?></h4> <p><?php echo lang('rolessettings_edit_hallo');?></p></div>
									   ...
									   ?>
                                            <form id="editRoles">
													<div class="form-group row">
													  <label for="idposition" class="col-sm-2 col-form-label"><?php echo lang('position');?></label>
														...
														<?php
															...
															{
																if($dp["idposition"]==$dr["idposition"])
																{	
														?>
																<option value="<?php echo $dp["idposition"];?>" selected><?php echo $dp["position"];?></option>
														<?php
																}
																else
																{
													...
													<div class="form-group row">
														...
														<div class="col-sm-10">
															<input type="text" class="form-control" name="roles" id="roles" placeholder="<?php echo lang('roles');?>" value="<?php echo $dr["roles"];?>" required>
														</div>
													</div>											
													<div class="form-group row">
                                                    <div class="col-sm-10">
