...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8">
        <title><?php echo lang('website_name');?> - <?php echo lang('dashboard');?></title>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body p-4 text-center">
                                    ...
                                    <div class="my-auto">
                                        <img src="<?php echo base_url();?>assets/dist/images/wallet.png" alt="author" width="48" class="my-auto">
                                    </div>
