							...
							<table id="data" class="display table dataTable table-striped table-bordered" >
								<thead >
									<tr>
										...
										<th><?php echo lang($namespace.'_coursessubcategory');?></th>
								...
								?>	
									<tr>
									  ...
									  <td><?php echo $d["coursessubcategory"];?></td>
										...
										<div class="modal-dialog modal-dialog-centered" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<?php echo lang('delete_info');?>, <?php echo $d["idcoursessubcategory"];?> - <?php echo strip_tags($d["coursessubcategory"]);?> <?php echo lang('riddle');?>
												</div>
												<div class="modal-footer">
													<button type="button" class="btn btn-secondary" data-dismiss="modal"><?php echo lang('close');?></button>
													<button type="button" class="btn btn-primary delete" data-id="<?php echo $d["idcoursessubcategory"];?>"><?php echo lang('delete');?></button>
												</div>
											</div>
										</div>
										</form>
