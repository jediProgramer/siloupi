		...
		<div class="row">
			<div class="col-12  align-self-center">
				<div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
					<div class="w-sm-100 mr-auto"><h4 class="mb-0"><?php echo $menuname;?></h4> <p><?php echo lang('menusettings_third_add_hallo');?></p></div>
                                        ...
                                        <div class="col-12">
											...
											<div class="card-body">
													...
													<div class="form-group row">
														...
														<div class="col-sm-10">
															<input type="text" class="form-control" name="subnavigation" id="subnavigation" placeholder="<?php echo lang('menuthird_name');?>" required>
														</div>
													</div>
													<div class="form-group row">
