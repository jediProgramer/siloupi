							...
							<table id="data" class="display table dataTable table-striped table-bordered" >
								<thead >
									<tr>
										...
										<th><?php echo lang($namespace.'_idcoursessubcategory');?></th>
										<th><?php echo lang($namespace.'_idsemester');?></th>
										<th><?php echo lang($namespace.'_courses');?></th>
										<th><?php echo lang($namespace.'_credit');?></th>
										...
										<div class="modal-dialog modal-dialog-centered" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<?php echo lang('delete_info');?>, <?php echo $d["idcourses"];?> - <?php echo strip_tags($d["courses"]);?> <?php echo lang('riddle');?>
												</div>
												<div class="modal-footer">
													<button type="button" class="btn btn-secondary" data-dismiss="modal"><?php echo lang('close');?></button>
													<button type="button" class="btn btn-primary delete" data-idc="<?php echo $d["idcurriculum"];?>"  data-id="<?php echo $d["idcourses"];?>"><?php echo lang('delete');?></button>
												</div>
											</div>
										</div>
										</form>
