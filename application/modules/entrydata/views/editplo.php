		...
		<div class="row">
			<div class="col-12  align-self-center">
				<div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
					<div class="w-sm-100 mr-auto"><h4 class="mb-0"><?php echo $menuname;?></h4> <p><?php echo lang('edit_plo');?></p></div>
                                    ...
                                    <div class="row">                                           
                                        <div class="col-12">
                                            ...
                                            <form id="editPLO">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-10">
													    <input type="hidden" class="form-control" id="idplo" name="idplo" value="<?php echo $d["idplo"];?>">
